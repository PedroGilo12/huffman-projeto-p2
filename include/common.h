...
typedef struct byte_frequency {
   unsigned char byte;               /**< Byte armazenado*/
...
typedef struct huffman_tree {
   ...
   unsigned char * preorder;             /**< Árvore de huffman em pré-ordem */
...
*/
int insert_byte_frequency_at_beginning(linked_list_t **head, const unsigned char *byte, unsigned long frequency);
